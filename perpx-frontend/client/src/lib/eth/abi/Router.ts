// client/src/lib/eth/abi/Router.ts
...
export const ROUTER_ABI = [
  ...
  "event MarginDeposited(address indexed user,uint256 amount,uint256 timestamp)",
  "event MarginWithdrawn(address indexed user,uint256 amount,uint256 timestamp)",
